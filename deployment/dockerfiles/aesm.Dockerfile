...
ARG SGX_MAJOR_VERSION=2.11.1
ARG SGX_MINOR_VERSION=00.2
...
ADD https://download.01.org/intel-sgx/sgx-linux/${SGX_MAJOR_VERSION}/distro/${OS_NAME}/debian_pkgs/libs/libsgx-pce-logic/libsgx-pce-logic_1.8.100.2-${OS_REVESION}_amd64.deb ./sgx/
ADD https://download.01.org/intel-sgx/sgx-linux/${SGX_MAJOR_VERSION}/distro/${OS_NAME}/debian_pkgs/libs/libsgx-qe3-logic/libsgx-qe3-logic_1.8.100.2-${OS_REVESION}_amd64.deb ./sgx/
ADD https://download.01.org/intel-sgx/sgx-linux/${SGX_MAJOR_VERSION}/distro/${OS_NAME}/debian_pkgs/libs/libsgx-ae-qe3/libsgx-ae-qe3_1.8.100.2-${OS_REVESION}_amd64.deb ./sgx/
...
RUN dpkg -i ./sgx/libsgx-enclave-common_${SGX_VERSION}-${OS_REVESION}_amd64.deb && \
    ...
    dpkg -i ./sgx/libsgx-pce-logic_1.8.100.2-${OS_REVESION}_amd64.deb&& \
    dpkg -i ./sgx/libsgx-ae-qe3_1.8.100.2-${OS_REVESION}_amd64.deb&& \
    dpkg -i ./sgx/libsgx-qe3-logic_1.8.100.2-${OS_REVESION}_amd64.deb&& \
    # AESM plugins
