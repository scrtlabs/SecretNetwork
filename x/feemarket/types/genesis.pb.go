...
type GenesisState struct {
	...
	LastBlockGas uint64 `protobuf:"varint,2,opt,name=last_block_gas,json=lastBlockGas,proto3" json:"last_block_gas,omitempty"`
}
...
func (m *GenesisState) GetLastBlockGas() uint64 {
	if m != nil {
...
var fileDescriptor_6241c21661288629 = []byte{
	...
	0x45, 0x5c, 0x3c, 0xee, 0x10, 0x6b, 0x82, 0x4b, 0x12, 0x4b, 0x52, 0x85, 0x6c, 0xb8, 0xd8, 0x0a,
	0x12, 0x8b, 0x12, 0x73, 0x8b, 0x25, 0x18, 0x15, 0x18, 0x35, 0xb8, 0x8d, 0xe4, 0xf4, 0xb0, 0x5b,
	0xab, 0x17, 0x00, 0x56, 0xe5, 0xc4, 0x72, 0xe2, 0x9e, 0x3c, 0x43, 0x10, 0x54, 0x8f, 0x90, 0x0a,
	0x17, 0x5f, 0x4e, 0x62, 0x71, 0x49, 0x7c, 0x52, 0x4e, 0x7e, 0x72, 0x76, 0x7c, 0x7a, 0x62, 0xb1,
	0x04, 0x93, 0x02, 0xa3, 0x06, 0x4b, 0x10, 0x0f, 0x48, 0xd4, 0x09, 0x24, 0xe8, 0x9e, 0x58, 0xec,
	...
	0x19, 0xa5, 0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0xc5, 0xc9, 0x45, 0x25, 0x39, 0x89, 0x49, 0xc5,
	0xfa, 0xc1, 0xa9, 0xc9, 0x45, 0xa9, 0x25, 0x7e, 0xa9, 0x25, 0xe5, 0xf9, 0x45, 0xd9, 0xfa, 0x15,
	0x48, 0xbe, 0x2c, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0xfb, 0xc4, 0x18, 0x10, 0x00, 0x00,
	0xff, 0xff, 0x08, 0x3e, 0x54, 0x96, 0x47, 0x01, 0x00, 0x00,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.LastBlockGas != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.LastBlockGas))
		i--
		dAtA[i] = 0x10
	}
	{
...
func (m *GenesisState) Size() (n int) {
	...
	if m.LastBlockGas != 0 {
		n += 1 + sovGenesis(uint64(m.LastBlockGas))
	}
	return n
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastBlockGas", wireType)
			}
			m.LastBlockGas = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastBlockGas |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
