...
func NewKeeper(cdc *codec.Codec, storeKey sdk.StoreKey, accountKeeper auth.AccountKeeper, bankKeeper *bank.Keeper, distKeeper *distr.Keeper,
	...
	keeper.queryPlugins = DefaultQueryPlugins(distKeeper, bankKeeper, stakingKeeper, &keeper).Merge(customPlugins)
	return keeper
}
