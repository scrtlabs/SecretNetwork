...
func (*QuoteReport) Descriptor() ([]byte, []int) {
	return fileDescriptor_799802904e8e109a, []int{0}
}
...
func (*QuoteReportBody) Descriptor() ([]byte, []int) {
	return fileDescriptor_799802904e8e109a, []int{1}
}
...
func (*QuoteReportData) Descriptor() ([]byte, []int) {
	return fileDescriptor_799802904e8e109a, []int{2}
}
...
func (*EndorsedAttestationReport) Descriptor() ([]byte, []int) {
	return fileDescriptor_799802904e8e109a, []int{3}
}
...
func (*SGXEC256Signature) Descriptor() ([]byte, []int) {
	return fileDescriptor_799802904e8e109a, []int{4}
}
...
func (*PlatformInfoBlob) Descriptor() ([]byte, []int) {
	return fileDescriptor_799802904e8e109a, []int{5}
}
...
func init() {
	proto.RegisterFile("secret/registration/remote_attestation/v1beta1/types.proto", fileDescriptor_799802904e8e109a)
}

var fileDescriptor_799802904e8e109a = []byte{
	...
	,
}
