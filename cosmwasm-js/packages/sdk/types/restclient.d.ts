...
declare type RestClientResponse = NodeInfoResponse | BlockResponse | AuthAccountsResponse | TxsResponse | SearchTxsResponse | PostTxsResponse | EncodeTxResponse | WasmResponse<string> | WasmResponse<CodeInfo[]> | WasmResponse<CodeDetails> | WasmResponse<ContractInfo[] | null> | WasmResponse<ContractDetails | null> | WasmResponse<ContractHashResponse | null>;
/**
...
export declare class RestClient {
     ...
     */
    queryContractSmart(contractAddress: string, query: object, addedParams?: object, contractCodeHash?: string): Promise<JsonObject>;
    /**
