...
docker_base:
	docker build --build-arg WITH_ROCKSDB=${WITH_ROCKSDB} --build-arg FEATURES=${FEATURES} --build-arg SGX_MODE=${SGX_MODE} -f deployment/dockerfiles/base.Dockerfile -t rust-go-base-image .
