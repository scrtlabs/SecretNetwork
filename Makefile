...
xgo_build_secretcli: go.sum
	...
	xgo --image techknowlogick/xgo:go-1.17.9 --targets $(XGO_TARGET) -tags="$(GO_TAGS) secretcli" -ldflags '$(LD_FLAGS)' --branch "$(CURRENT_BRANCH)" github.com/enigmampc/SecretNetwork/cmd/secretd
