...
pub struct Keychain {
    ...
    consensus_io_exchange_keypair: SeedsHolder<KeyPair>,
...
impl Keychain {
    ...
    pub fn new_empty() -> Self {
        Keychain {
            ...
            consensus_io_exchange_keypair: SeedsHolder { arr: Vec::new() },
