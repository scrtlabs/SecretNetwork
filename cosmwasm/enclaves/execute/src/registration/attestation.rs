...
lazy_static::lazy_static! {
    ...
    static ref PPID_WHITELIST: HashSet<[u8; 20]>  = {
        ...
        set.insert([0xf4,0xe1,0x2f,0x72,0xac,0xcd,0xc8,0x3e,0xa3,0xe1,0x6b,0x73,0x07,0x79,0x69,0x0b,0x4a,0x9e,0x0b,0xed]); // scarcz
        set.insert([0x22,0x1c,0xd8,0x23,0x4e,0x36,0x9e,0xf1,0x9d,0xfd,0xad,0x94,0xf4,0x37,0xd3,0xa1,0x90,0xcb,0x26,0x73]); // YoloNode-NG
        set.insert([0xc8,0x63,0x8d,0xc5,0xe9,0x29,0x33,0x70,0x9f,0x64,0x7c,0xa7,0xab,0x78,0xee,0xb3,0x9d,0x39,0x95,0x75]); // SecretSaturn
        set.insert([0x24,0x91,0xb9,0xa2,0x2f,0x4b,0x3d,0x45,0x82,0xaf,0x20,0x92,0x19,0x19,0xbc,0x27,0x71,0xc8,0x0f,0xde]); // AdamantFI
        set.insert([0x84,0xca,0x01,0x28,0x46,0x31,0x54,0x15,0x12,0x65,0x21,0xd8,0xaf,0xdf,0x5d,0xda,0x5f,0x77,0x53,0x06]); // Alter
        set.insert([0x41,0x01,0xa8,0x18,0x7d,0x20,0x88,0x9c,0x4f,0xd2,0x47,0xb4,0xc8,0x27,0x9b,0x66,0x31,0x8e,0xf0,0x91]); // wdc8
        set.insert([0x57,0xa6,0x87,0x7d,0x0e,0x96,0xce,0x77,0xa3,0xfa,0xfb,0x0c,0x2f,0x7e,0x9e,0xd9,0xe2,0x8f,0xb0,0x37]); // wd3
        set.insert([0xa0,0x41,0x7d,0x62,0x7d,0x22,0x5e,0x21,0x54,0x3c,0xf9,0xa9,0x1b,0x2d,0x83,0xb9,0x5f,0x09,0x1d,0xc6]); // dankuzone
        set.insert([0x31,0x5d,0xb0,0x4d,0xf6,0x69,0x89,0x4a,0x3e,0x35,0x42,0x96,0x91,0xb8,0xb3,0x50,0xd8,0xcb,0xcd,0xe2]); // colossus-s4
        set.insert([0x2a,0x00,0x3f,0x2b,0x90,0x8b,0x08,0x47,0x6b,0xe2,0x5d,0x01,0x1c,0x57,0xfe,0x11,0xfc,0x68,0x92,0xf9]); // SCRT-NETWORK-UTC
        set.insert([0xc4,0xc1,0x07,0x66,0xc4,0x48,0x9b,0x71,0x77,0xcf,0x5a,0x21,0xa0,0xdc,0x48,0xe6,0x89,0x99,0x9a,0xe8]); // chocolate
        set.insert([0x28,0x04,0x9f,0x3f,0x69,0xf6,0x55,0x83,0x24,0xe5,0x2d,0x44,0xec,0xde,0xf8,0x97,0xb1,0xa3,0xb3,0x90]); // secret
        set.insert([0xc2,0xf7,0xf3,0xb6,0x0a,0xcd,0xe8,0xdd,0xff,0x16,0x71,0x04,0xc5,0x6e,0x1e,0xd5,0xa1,0xe3,0xeb,0x74]); // Fina
        set.insert([0x79,0x17,0x73,0xaa,0x0b,0x8a,0xe2,0xdc,0x8c,0xb7,0x5e,0xb9,0xd5,0x64,0xa0,0xd5,0x98,0x12,0x55,0x72]); // node7
        set.insert([0xb2,0xed,0x08,0x99,0x4a,0xe4,0xd6,0xdb,0x46,0xb3,0x16,0xd3,0x84,0x38,0x0f,0x69,0x63,0x64,0x04,0xfa]); // hbsecret
        set.insert([0x14,0xd1,0x23,0x60,0x33,0xfd,0xe3,0x1e,0x0b,0xcd,0x57,0x0c,0x32,0x91,0xea,0xa9,0xbd,0xb7,0xe2,0x5e]); // HSS
        set.insert([0x9d,0x08,0x17,0x1e,0xc1,0xca,0xe6,0xce,0x1e,0xa0,0xce,0x3f,0x36,0x74,0xfa,0x5d,0x01,0xf6,0xf1,0xb3]); // SecretSaturn
        set.insert([0xf2,0x28,0xe8,0xbb,0x0a,0xea,0x2e,0x37,0x06,0x6f,0x93,0xdb,0x5c,0xbf,0xd9,0x34,0x2d,0x8f,0xff,0x0d]); // wdc6
        set.insert([0x1a,0xe4,0xfb,0x51,0x62,0x6d,0x0d,0x27,0x4c,0x0b,0xd3,0x85,0x1e,0x5a,0x04,0xde,0xe0,0xb0,0xd5,0x3b]); // roboto
        set.insert([0x8f,0x06,0xc7,0xf4,0xf5,0xf8,0x68,0x42,0xae,0xe7,0x84,0x33,0x70,0x21,0xeb,0xd5,0x9d,0x4a,0xf9,0xf1]); // base1
        set.insert([0x78,0x27,0x70,0x25,0x3c,0x0a,0xe7,0x2e,0xdd,0x91,0x13,0x8a,0xd0,0x01,0x7c,0xdb,0x9a,0x7d,0x8d,0xba]); // wd1
        set.insert([0x48,0x82,0x28,0x89,0x4e,0x72,0x65,0xff,0x74,0xd9,0x74,0x95,0xd2,0xd5,0x36,0xb9,0xc7,0xf5,0x74,0x11]); // monik
        set.insert([0x05,0x04,0x30,0x40,0x8a,0x4c,0xea,0xe5,0xd0,0xb9,0xd9,0x57,0x21,0xd6,0x51,0x22,0x2c,0xbd,0x83,0xd3]); // Pathrocknetwork
        set.insert([0xe0,0xd1,0x22,0xf6,0x11,0xe3,0x79,0x5b,0x28,0xa2,0x41,0x57,0xa9,0xc0,0x10,0x8b,0xca,0x57,0x92,0xf4]); // node
        set.insert([0xc4,0xc2,0xef,0x79,0x5e,0x37,0x11,0x16,0xee,0xa7,0xfe,0x8b,0x98,0x1e,0x38,0xb7,0xe0,0xcf,0x10,0x17]); // Quiet monkey mind
        set.insert([0x7a,0x89,0xc9,0xdd,0x73,0x83,0xdd,0xe2,0x74,0x19,0xb3,0x6e,0x2c,0x6d,0x0d,0x94,0x2e,0xee,0x85,0xd9]); // wd5
        set.insert([0xc4,0xad,0x39,0x80,0xab,0x87,0x72,0xd4,0xd6,0x3b,0x0a,0x7f,0x51,0xba,0xdf,0x00,0x65,0xdc,0x09,0x5a]); // wd4
        set.insert([0xbb,0xed,0x9a,0xc0,0xc3,0xb9,0x20,0x3d,0x4d,0xa1,0x9c,0xab,0x34,0xfb,0xfb,0x8c,0xe6,0xa4,0x41,0x1c]); // b10z91
        set.insert([0x26,0x67,0x1a,0x09,0x31,0xeb,0xde,0x25,0x27,0x37,0x36,0xbf,0x6b,0x4b,0x2e,0xd1,0x03,0x8c,0x44,0x43]); // eatingcats
        set.insert([0x9a,0xce,0x47,0xea,0xcb,0xe6,0xab,0x51,0x12,0xbd,0x6d,0x8e,0xbc,0x55,0x5b,0x0f,0xef,0x9f,0x23,0x32]); // secretsauce2
        set.insert([0x53,0x54,0x3f,0x1a,0x7d,0x08,0xc1,0x3d,0x69,0x38,0x5b,0x81,0x20,0x56,0x2a,0x76,0xb8,0x71,0xf8,0xec]); // securesecrets
        set.insert([0x44,0xe1,0x05,0x97,0xb4,0x2e,0x57,0x14,0x23,0x91,0x53,0x85,0xfe,0x85,0xce,0xd0,0xe8,0x40,0x85,0x0c]); // wd2
        set.insert([0x35,0x99,0xc4,0x8a,0x2a,0x1b,0xbf,0xf8,0x74,0xda,0xc4,0x6d,0x98,0x6a,0x51,0x2f,0x69,0xfb,0xc8,0xd0]); // SpaceStake
        set.insert([0xd2,0x9e,0x7c,0x5a,0x8b,0x1c,0xbd,0xf6,0x36,0x29,0xf0,0x86,0x28,0x93,0xa8,0xf8,0x90,0x77,0xb4,0x1a]); // tactus
        set.insert([0x16,0x32,0xea,0x13,0x05,0x1c,0xc4,0xd3,0x92,0xcb,0x8d,0x3e,0x01,0x6e,0xb5,0x61,0x7d,0x8e,0x8b,0x2a]); // stashh-v
        set.insert([0xdb,0x76,0x94,0xa4,0x75,0xe9,0xd6,0xaf,0x40,0x09,0xb6,0x0c,0x4b,0xe0,0xec,0x87,0xad,0x1a,0x6e,0xc6]); // Tane
        set.insert([0x80,0xfc,0xb4,0xf6,0xf0,0x86,0xe6,0xbb,0xd8,0x32,0x50,0x0c,0x2b,0x72,0x9c,0x26,0xb3,0xbf,0x1a,0xd2]); // Whisper2
        set.insert([0x9c,0x80,0xbc,0x6b,0xf4,0x58,0x6e,0xdb,0x26,0x89,0xc3,0x09,0x3a,0x9a,0x0a,0xec,0xa3,0x01,0x48,0x05]); // myvm11
        set.insert([0x21,0xca,0xe8,0x22,0x31,0x4c,0x17,0x72,0x16,0x77,0xc4,0x1c,0xd8,0x42,0x34,0x64,0x98,0x35,0x53,0xc1]); // leaseweb 184.107.57.225
        set.insert([0x97,0x58,0x7e,0x41,0x8d,0xc1,0xaf,0xbc,0xa9,0x93,0x9c,0x06,0xcc,0xb9,0x7f,0x31,0x15,0xc5,0x8c,0x65]); // leaseweb 198.50.127.158
        set.insert([0xc3,0x1a,0x7d,0x5c,0x50,0x80,0xd9,0x0a,0x62,0x0d,0x36,0x48,0x54,0xba,0x33,0x6d,0xc8,0x2c,0xb2,0xc1]); // devnet2
        set.insert([0x4e,0x09,0x78,0x81,0x59,0x00,0x8f,0x91,0xd7,0xf3,0xd6,0x8b,0x1a,0xf2,0x35,0x5b,0x3c,0x17,0x72,0xcc]); // devnet3
        set.insert([0x51,0xc1,0xed,0xe1,0x8e,0x73,0xfc,0x7e,0x00,0xe8,0xfc,0x01,0x8e,0xde,0x53,0x63,0x2f,0x8b,0xb6,0xd9]); // devnet4
        set.insert([0x8f,0xfb,0xc5,0xef,0x59,0xef,0x9f,0x22,0x89,0xe7,0x4a,0x37,0x45,0x03,0x9d,0x90,0x0f,0xba,0x30,0xfe]); // binance node2
        set.insert([0x3e,0x68,0x30,0xd6,0xa2,0xd8,0x39,0xbf,0x36,0xbb,0x10,0x8c,0xa8,0xcc,0xc2,0x5a,0x16,0x78,0xf8,0x2f]); // binance node3
