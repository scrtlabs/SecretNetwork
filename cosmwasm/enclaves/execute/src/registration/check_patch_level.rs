...
pub unsafe extern "C" fn ecall_check_patch_level(
    ...
    // let cert = match epid::generate_authentication_material(
    //     &kp.get_pubkey(),
    //     SIGNATURE_TYPE,
    //     api_key_slice,
    //     secret_attestation_token::AttestationType::SgxEpid,
    //     None,
    // ) {
    //     Err(_) => {
    //         error!("Failed to get certificate from intel for seed service");
